...
function s.atkfilter(c)
	return Duel.IsExistingMatchingCard(aux.AND(Card.IsFaceup,Card.IsRace),0,LOCATION_MZONE,LOCATION_MZONE,1,c,c:GetRace())
end
...
function s.cfilter(c,e)
	return c:IsRelateToChain() and not c:IsImmuneToEffect(e)
end
