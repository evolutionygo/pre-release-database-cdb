...
function s.sptg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.IsPlayerCanSpecialSummonMonster(tp,id,0x2ae,TYPE_MONSTER+TYPE_EFFECT,2000,2200,6,RACE_ROCK,ATTRIBUTE_EARTH) end
...
function s.efilter(e,ct)
	...
	return p==tp and te:IsHasType(EFFECT_TYPE_ACTIVATE) and te:GetHandler():IsCode(101205053)
end