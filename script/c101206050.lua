...
function s.filter(c)
	return (c:IsSetCard(0x2bb) and c:IsType(TYPE_TRAP) or aux.IsCodeListed(c,101206071) and c:IsType(TYPE_MONSTER)) and c:IsAbleToHand()
end
...
function s.cfilter(c)
	return c:IsSetCard(0x2bb) and c:IsType(TYPE_TRAP)
end
